...
// --- Types (from modular types) ---
import type {
  YearStats, User, Department, Class, Task, Submission,
  Notification, HODStats, AdvisorStats, StudentStats,
  CoordinatorStats, ToastType, ToastMessage
} from './types';

// --- UI Components (from modular components) ---
import { Button, Input, Card, CircularProgress, SimpleBarChart, ToastContainer, Skeleton, EmptyState } from './components/ui';
